...
import {getAddresses, getCardName, getCoordinates, getFrom, getIsLoggedIn, getTo} from "../Redux/map-selector";
import classes from './Map.module.css'
import DestinationForm from "../DestinationForm/DestinationForm";
import {addressesRequest, coordinatesRequest, getArrival, getDeparture} from "../Redux/map-reducer";
...
class Map extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.coordinatesRequest('Эрмитаж', 'Пулково (LED)')
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.from !== this.props.from) {
            this.props.coordinatesRequest(this.props.from, this.props.to)
        }
